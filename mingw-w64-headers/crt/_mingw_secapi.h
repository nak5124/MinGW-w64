...
#else  /* defined(__cplusplus) && (MINGW_HAS_SECURE_API == 1) */
...
#else  /* (_CRT_SECURE_CPP_OVERLOAD_STANDARD_NAMES_MEMORY == 1) */
#define __CRT_SECURE_CPP_OVERLOAD_STANDARD_NAMES_MEMORY_0_3_(__ret, __func, __type1, __attrib1, __arg1, __type2, __attrib2, __arg2, __type3, __attrib3, __arg3) \
...
#endif  /* (_CRT_SECURE_CPP_OVERLOAD_STANDARD_NAMES_MEMORY == 1) */
