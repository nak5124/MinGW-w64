...
#endif  /* !__SSE2__ */
#endif  /* !__MINGW_FORCE_SYS_INTRINS */
...
#endif  /* __cplusplus */
#endif  /* defined(__MMX__) || defined(__MINGW_FORCE_SYS_INTRINS) */
...
#endif  /* __cplusplus */
#endif  /* defined(__3dNOW__) || defined(__MINGW_FORCE_SYS_INTRINS) */
...
#endif  /* __cplusplus */
#endif  /* defined(__SSE__) || defined(__MINGW_FORCE_SYS_INTRINS) */
...
#endif  /* __cplusplus */
#endif  /* defined(__SSE2__) || defined(__MINGW_FORCE_SYS_INTRINS) */
...
#endif  /* __cplusplus */
#endif  /* defined(__SSE3__) || defined(__MINGW_FORCE_SYS_INTRINS) */
...
#else  /* !USE_NO_MINGW_SETJMP_TWO_ARGS */
...
#endif  /* !USE_NO_MINGW_SETJMP_TWO_ARGS */
#endif  /* !__CYGWIN__ */
...
#endif  /* !defined(__GNUC__) || (!defined(__MMX__) && !defined(__MINGW_FORCE_SYS_INTRINS)) */
...
#endif  /* !defined(__GNUC__) || (!defined(__SSE__) && !defined(__MINGW_FORCE_SYS_INTRINS)) */
#if !defined(__GNUC__) || (!defined(__SSE__) && !defined(__MINGW_FORCE_SYS_INTRINS))
...
#endif  /* !defined(__GNUC__) || (!defined(__3dNOW__) && !defined(__MINGW_FORCE_SYS_INTRINS)) */
...
#endif  /* !defined(__GNUC__) || (!defined(__SSE2__) && !defined(__MINGW_FORCE_SYS_INTRINS)) */
...
#endif  /* !defined(__GNUC__) || (!defined(__SSE3__) && !defined(__MINGW_FORCE_SYS_INTRINS)) */
