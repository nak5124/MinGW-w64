...
int __cdecl (*__MINGW_IMP_SYMBOL(_stat64))(const char *, struct _stat64 *) = _stat64;
...
static int __cdecl _stub(const char *_Filename, struct _stat64 *_Stat)
{
  ...
  f = (int __cdecl (*)(const char *, struct _stat64 *))GetProcAddress(__mingw_get_msvcrt_handle(), "_stat64");
...
#ifdef _WIN64
int __cdecl (*__MINGW_IMP_SYMBOL(_stat))(const char *, struct _stat64i32 *) = _stat64i32;
int __cdecl _stat(const char *_Filename, struct _stat64i32 *_Stat) __attribute__((alias("_stat64i32")));
int __cdecl (*__MINGW_IMP_SYMBOL(_stati64))(const char *, struct _stat64 *) = _stat64;
int __cdecl _stati64(const char *_Filename, struct _stat64 *_Stat) __attribute__((alias("_stat64")));
#else  /* _WIN64 */
int __cdecl (*__MINGW_IMP_SYMBOL(_stat))(const char *, struct _stat32 *) = _stat32;
int __cdecl _stat(const char *_Filename, struct _stat32 *_Stat) __attribute__((alias("_stat32")));
int __cdecl (*__MINGW_IMP_SYMBOL(_stati64))(const char *, struct _stat32i64 *) = _stat32i64;
int __cdecl _stati64(const char *_Filename, struct _stat32i64 *_Stat) __attribute__((alias("_stat32i64")));
#endif  /* _WIN64 */
